...
def add_map_elements(fmap):
    ...
    # layer control. Move all color-ramp legends to the bottom-right and scale
    # them down. When multiple color ramps exist, stack them upward.
