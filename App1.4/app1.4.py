...
st.markdown(
    ...
    /* Make wide Streamlit tables easier to scroll horizontally inside the narrow sidebar. */
    ...
    section.main div[data-testid="stRadio"]:has(label),
    div[data-testid="stAppViewContainer"] section.main div[data-testid="stRadio"] {
