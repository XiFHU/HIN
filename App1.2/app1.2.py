...
# -----------------------------
# 7. Sliding Window Risk Analysis
# -----------------------------

st.header("7. Sliding Window Risk Analysis")
...
if selected_roads is None:
    ...
    if "section7_results" in st.session_state:
        ...
        st.subheader("Corridor Context Map")
        ...
        st_folium(
            ...
            width=1200,
            height=650,
            key="section7_context_map"
        )

        # -----------------------------
        # Risk Corridor Table / Downloads / Map
        # -----------------------------
